...
public class GenerateQuestionManager {
    ...
    public String generateQuestionByUserResponse(List<Question> questionList, String userResponse) {
        ...
        if (question != null) {
            List<Question> questions = (List<Question>) CacheUtils.get("questionList");
            questions.remove(question);
            CacheUtils.putSession("questionList", questions);
    ...
    private List<Question> getQuestions(GenerateQuestion generateQuestion) {
        if (!CacheUtils.containsKeyInCache("questionList")) {
            ...
            CacheUtils.put("questionList", questions);
        }
        List<Question> questionList = (List<Question>) CacheUtils.getCache("questionList");
        return questionList;
    }
    ...
    private List<Question> getStaticQuestionList() {
        ...
        questionList.add(new Question( "What is the difference between == and .equals() in Java?", "Java", "Core Java Concepts", "Basic", "Intermediate", "2-5 years"));

        questionList.add(new Question("Explain the concept of method overloading in Java.", "Java", "Core Java Concepts", "Intermediate", "Intermediate", "2-5 years"));

        questionList.add(new Question("What is the purpose of the transient keyword in Java?", "Java", "Core Java Concepts", "Intermediate", "Intermediate", "2-5 years"));

        questionList.add(new Question("Describe the difference between StringBuilder and StringBuffer.", "Java", "Core Java Concepts", "Intermediate", "Intermediate", "2-5 years"));

        questionList.add(new Question("How does Java support multiple inheritances through interfaces?", "Java", "Object-Oriented Programming (OOP)", "Intermediate", "Intermediate", "2-5 years"));

        questionList.add(new Question("What is the purpose of the volatile keyword in Java?", "Java", "Multi-Threading", "Advanced", "Intermediate", "5+ years"));

        questionList.add(new Question("Explain the concept of autoboxing and unboxing in Java.", "Java", "Core Java Concepts", "Basic", "Intermediate", "2-5 years"));

        questionList.add(new Question("What is the super keyword used for in Java?", "Java", "Core Java Concepts", "Basic", "Intermediate", "2-5 years"));

        questionList.add(new Question("How can you achieve a Singleton pattern in Java?", "Java", "Design Patterns", "Intermediate", "Intermediate", "2-5 years"));

        questionList.add(new Question("Describe the differences between ArrayList and LinkedList.", "Java", "Java Collections Framework", "Intermediate", "Intermediate", "2-5 years"));

        questionList.add(new Question("Explain the concept of anonymous classes in Java.", "Java", "Core Java Concepts", "Intermediate", "Intermediate", "2-5 years"));

        questionList.add(new Question("What is the significance of the @Override annotation?", "Java", "Core Java Concepts", "Basic", "Intermediate", "2-5 years"));

        // Question 13
        questionList.add(new Question("How does the static block differ from the static method in Java?", "Java", "Core Java Concepts", "Intermediate", "Intermediate", "2-5 years"));

        // Question 14
        questionList.add(new Question("What is the purpose of the Comparable interface?", "Java", "Java Collections Framework", "Intermediate", "Intermediate", "2-5 years"));

        // Question 15
        questionList.add(new Question("Explain the difference between String and StringBuffer in terms of mutability.", "Java", "Core Java Concepts", "Basic", "Intermediate", "2-5 years"));

        // Question 16
        questionList.add(new Question("Describe the Observer design pattern in Java.", "Java", "Design Patterns", "Intermediate", "Intermediate", "2-5 years"));

        // Question 17
        questionList.add(new Question("What is the purpose of the final class in Java?", "Java", "Core Java Concepts", "Intermediate", "Intermediate", "2-5 years"));

        // Question 18
        questionList.add(new Question("Explain the concept of method overriding in Java.", "Java", "Core Java Concepts", "Basic", "Intermediate", "2-5 years"));

        // Question 19
        questionList.add(new Question("How can you handle exceptions in a multi-threaded environment?", "Java", "Multi-Threading", "Advanced", "Intermediate", "5+ years"));

        // Question 20
        questionList.add(new Question("Describe the principles of Dependency Injection (DI) in Java.", "Java", "Design Patterns", "Intermediate", "Intermediate", "2-5 years"));

        questionList.add(new Question("What is the purpose of the 'finally' block in exception handling?", "Java", "Exception Handling", "Intermediate", "Intermediate", "2-5 years"));

        // Question 22
        questionList.add(new Question("Explain the concept of lambda expressions in Java.", "Java", "Java 8 Features", "Intermediate", "Intermediate", "2-5 years"));
